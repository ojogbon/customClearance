class ConfirmBooking {
    ...
    update (id,value) {
        const url = `../includes/Booking.php?key=1234567opiuyt&method=update&id=${id}&value=${value}`;
...
const confirmBooking = new ConfirmBooking("includes/User.php?key=1234567opiuyt&method=insert");
confirmBooking.doClick();
