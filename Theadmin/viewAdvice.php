...
<head>
    ...
    <title>Cool Clear Custom Admin | Bill</title>
                                        ...
                                        foreach ($advicePayments as $advicePayment => $value){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button data-id="<?php echo $advicePayment[$advicePayment]["id"];?>" class="btn btn-danger addClose"><i data-id="<?php echo $advicePayments[$advicePayment]["id"];?>" class="ti-close"></i></button>
