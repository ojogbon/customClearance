                            ...
                            <div class="card alert">
                                <div class="card-header">
                                    ...
                                    <div class="card-header-right-icon">
										<ul>
											 <li class="card-close"><a href="viewAdvice.php"><i class="ti-view-list"></i>View Advice </a></li>
										</ul>
									</div>
                                </div>
                                <div class="card-body">
                                   <form method="post" enctype="multipart/form-data">
                                       <div class="form-group">
                                           ...
                                           <input class="form-control" type="text" placeholder="Advice Type..." name="type"/>
                                       </div>
                                       <div class="form-group">
                                       ...
                                       <div class="form-group">
                                                <button class="btn btn-default" name="adAdvice">add</button>
                                       </div>

                                   </form>
                                    <?php

                                        if (isset($_POST["adAdvice"])){
                                            $type = $_POST["type"];
                                            $amount = $_POST["amount"];

;
                                            if (!$advice->saveAdvice(" `advice`(`id`, `officedr_id`, `type`, `amount`, `date`, `status`)",
