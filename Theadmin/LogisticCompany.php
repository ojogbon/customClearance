                                    ...
                                    <table class="table table-responsive">
                                        ...
                                        foreach ($logistics as $logistic => $value){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $logistics[$logistic]["name"];?></td>
                                                <td><?php echo $logistics[$logistic]["companyName"];?></td>
                                                <td><?php echo $logistics[$logistic]["email"];?></td>
                                                <td><?php echo $logistics[$logistic]["phoneNumber"];?></td>
                                                <td><?php echo $logistics[$logistic]["date"];?></td>
